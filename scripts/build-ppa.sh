...
CARGO_CONFIG
    ...
    # Downgrade edition2024 to edition2021 for Ubuntu noble's Cargo 1.75.0
    find "$src_dir/vendor" -name Cargo.toml -exec sed -i -e 's/^edition = "2024"$/edition = "2021"/' -e 's/^resolver = "3"$/resolver = "2"/' {} +
